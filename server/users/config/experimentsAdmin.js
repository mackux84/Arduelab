      ...
      responses: {
        '200': {
          ...
          'schema': Joi.object({
            ...
            schedule: Joi.array().length(4).items(Joi.number().min(0).max(24)).required().description('Las horas activas del experimento (inicio,fin-inicio,fin) formato 24h').example('[8,12,14,18]'),
